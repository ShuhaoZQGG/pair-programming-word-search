...
const wordSearch = (letters, word) => {
  ...
  */
  const diagnalLetters2 = diagnalTranspose(transpose(letters));
  const diagnalJoin2 = findWord(diagnalLetters2, word);
  if (diagnalJoin2) return true;
